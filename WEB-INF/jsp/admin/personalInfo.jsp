        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input"  name="username"
                       value="${admin1.username}" disabled="disabled" >
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="nickname"
                       value="${admin1.nickname}" lay-verify="nickname" autocomplete="off"
                placeholder="请输入昵称">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="phone"
                       value="${admin1.phone}" lay-verify="required|phone" autocomplete="off">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="email"
                       value="${admin1.email}" lay-verify="required|email" autocomplete="off">
            </div>
        </div>
