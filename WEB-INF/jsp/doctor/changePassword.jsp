...
<div class="layui-card-body" pad15="">
    <form class="layui-form" id="cpwd">
        <input type="hidden" name="doctor_id" value="${hotel_user.doctor_id}"/>
        <div class="layui-form-item">
            <label class="layui-form-label">用户名：</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="username"
                       value="${hotel_user.username}" disabled="disabled">
            </div>
        </div>
        <div class="layui-form-item">
    ...
    <script type="text/javascript" src="${ctx }/js/doctor/changePassword.js"></script>
