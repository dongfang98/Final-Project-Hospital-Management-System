...
//下面四个时间选择器 改的很简单就是 后面的不能比前面的小就行了
    ...
    table.render({
        ...
        limits:[10,20,30,40],
        cols:[[
            {field:'user_id',title:'No.',align:'center',width:80},
            {field:'photo_path',title:'Portrait',align:'center',width:110,templet: "#imgtmp"},
            {field:'username',title:'User name',align:'center',width:110},
            {field:'realname',title:'Name',align:'center',width:110},
            {field:'gender',title:'Gender',align:'center',templet:'#sexTpl',width:60},
            {field:'phone',title:'Phone',align:'center',width:120},
            {field:'email',title:'E-mail',align:'center',width:180},
            {field:'address',title:'Addr',align:'center',width:180},
            {field:'levelId',title:'Covid-19',align:'center',width:120,templet:'#levelIdTpl'},
            {field:'create_time',title:'Regtime',align:'center',width:160,
                templet:'<div>{{ formatTime(d.createTime,"yyyy-MM-dd hh:mm:ss")}}</div>'},
            {title:'Settings',align:'center',width:180,toolbar:"#barDemo"}  //注意！！！！
