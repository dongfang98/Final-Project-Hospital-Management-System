...
layui.use(['form','jquery','table','laydate'],function () {
    ...
    table.render({
        ...
        cols:[[
            ...
            {field:'realname',title:'Name',align:'center',width:110,templet: '<div>{{d.doctor.realname}}</div>'},
            {field:'rank',title:'Title',align:'center',width:120,templet:'#rankTpl'},
            {field:'order_time',title:'Date',align:'center',width:160,
                templet:'<div>{{ formatTime(d.order_time,"yyyy-MM-dd hh:mm:ss")}}</div>'},
            {title:'Cancel',align:'center',width:180,toolbar:"#barDemo"}  //注意！！！！
