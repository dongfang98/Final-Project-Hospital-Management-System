...
<form class="layui-form" style="width: 80%;" id="arf">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">Role description</label>
        <div class="layui-input-block">
            <textarea placeholder="请输入角色描述" class="layui-textarea linksDesc"
                      lay-verify="required" name="roleRemark">${role.roleRemark}</textarea>
        </div>
    </div>
    <!--权限树 xtree-->
    <div class="layui-form-item">
        <label class="layui-form-label">Assign permissions</label>
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <button class="layui-btn" lay-submit="" lay-filter="editRole">Submit</button>
        </div>
    </div>
</form>
