...
<div class="layui-form">
    <table class="layui-table layui-table-cell"  id="doctorResList" lay-filter="doctorResList"></table>
</div>
...
<script type="text/html" id="barDemo">
    ...
    <a class="layui-btn layui-btn-sm layui-btn-danger" lay-event="accept">
        <i class="layui-icon">&#xe642;</i>
    </a>
</script>

<script type="text/html" id="imgtmp">
    <img src="../../hospital/img/{{d.user.photo_path}}" />
</script>

<script type="text/javascript" src="${ctx }/layui/layui.js"></script>
<script type="text/javascript" src="${ctx }/js/reservation/doctorResList.js"></script>
